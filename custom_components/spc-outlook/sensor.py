    ...
    for day in range(1, 4):
        ...
        for feature in data['features']:
            ...
            if polygon.contains(location):
                print('Day ' + str(day) + ' Categorical Risk: ', 
                       feature['properties']['LABEL2'])
                result = True
        if result and day < 3:
            torn_url = 'https://www.spc.noaa.gov/products/outlook/day' + str(day) 
                + 'otlk_torn.lyr.geojson'
            ...
            hail_url = 'https://www.spc.noaa.gov/products/outlook/day'
                       +str(day)+'otlk_hail.lyr.geojson'
